    ...
    /****************************************************
    Loading this file in magma loads the objects fs_6F1 
    and X_6F1. fs_6F1 is a list of power series which form 
    a basis for the space of cusp forms. X_6F1 is a 
    ...
    *****************************************************/
              ...
              fs_6F1 := [Kq | q - 4*q^7 + 2*q^13 + 8*q^19 - 5*q^25 - 4*q^31 - 
...
O(q^366)] ;
              ...
              X_6F1 := Curve(P_Q, [ PolynomialRing(RationalField(), 2) | ]);
