    ...
    /****************************************************
    Loading this file in magma loads the objects fs_8C1 
    and X_8C1. fs_8C1 is a list of power series which form 
    a basis for the space of cusp forms. X_8C1 is a 
    ...
    *****************************************************/
              ...
              fs_8C1 := [Kq | q + 2*q^5 - 3*q^9 - 6*q^13 + 2*q^17 - q^25 + 
...
22*q^157 + 23*q^169 + 26*q^173 + O(q^176)] ;
              ...
              X_8C1 := Curve(P_Q, [ PolynomialRing(ext<K|Polynomial(K, [-2, 0, 
