    ...
    /****************************************************
    Loading this file in magma loads the objects fs_16J1 
    and X_16J1. fs_16J1 is a list of power series which form 
    a basis for the space of cusp forms. X_16J1 is a 
    ...
    *****************************************************/
              ...
              fs_16J1 := [Kq | q^2 + 2*q^6 + 2*q^10 - 4*q^14 + q^18 - 2*q^22 + 
...
18*q^346 + 4*q^350 + 28*q^354 - 6*q^358 + 2*q^362 + 4*q^366 + O(q^368)] ;
              ...
              X_16J1 := Curve(P_Q, [ PolynomialRing(ext<K|Polynomial(K, [2, 0, 
