    ...
    /****************************************************
    Loading this file in magma loads the objects fs_16I1 
    and X_16I1. fs_16I1 is a list of power series which form 
    a basis for the space of cusp forms. X_16I1 is a 
    ...
    *****************************************************/
              ...
              fs_16I1 := [Kq | q + 2*q^3 + q^9 + 6*q^11 - 6*q^17 + 2*q^19 - 
...
14*q^337 + 36*q^339 + 6*q^347 - 30*q^353 - 15*q^361 + 50*q^363 + O(q^368)] ;
              ...
              X_16I1 := Curve(P_Q, [ PolynomialRing(ext<K|Polynomial(K, [2, 0, 
