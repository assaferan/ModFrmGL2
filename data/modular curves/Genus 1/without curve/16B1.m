    ...
    /****************************************************
    Loading this file in magma loads the objects fs_16B1 
    and X_16B1. fs_16B1 is a list of power series which form 
    a basis for the space of cusp forms. X_16B1 is a 
    ...
    *****************************************************/
              ...
              fs_16B1 := [Kq | q - 4*q^5 - 3*q^9 - 4*q^13 - 2*q^17 + 11*q^25 - 
...
36*q^349 + 34*q^353 - 19*q^361 + 24*q^365 + O(q^368)] ;
              ...
              X_16B1 := Curve(P_Q, [ PolynomialRing(ext<K|Polynomial(K, [2, 0, 
