    ...
    /****************************************************
    Loading this file in magma loads the objects fs_12E2 
    and X_12E2. fs_12E2 is a list of power series which form 
    a basis for the space of cusp forms. X_12E2 is a 
    ...
    *****************************************************/
              ...
              fs_12E2 := [Kq | q^2 - 4*q^14 + 2*q^26 + 8*q^38 - 5*q^50 - 4*q^62 
...
4*q^302 + 14*q^314 + 8*q^326 + O(q^336), q^2 - 4*q^14 + 2*q^26 + 8*q^38 - 5*q^50
- 4*q^62 - 10*q^74 + 8*q^86 + 9*q^98 + 14*q^122 - 16*q^134 - 10*q^146 - 4*q^158 
- 8*q^182 + 14*q^194 + 20*q^206 + 2*q^218 - 11*q^242 + 20*q^254 - 32*q^266 - 
16*q^278 - 4*q^302 + 14*q^314 + 8*q^326 + O(q^336), q - 2*q^3 - 2*q^5 - 2*q^9 - 
...
12*q^333 - 8*q^335 + O(q^336)] ;
              P_Q<[x]> := ProjectiveSpace(Rationals(), 1);
              X_12E2 := Curve(P_Q, [ PolynomialRing(ext<K|Polynomial(K, [-3, 0, 
