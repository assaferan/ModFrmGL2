...
// finally do G - Bill's new code follows - add whole group even when
// GR`trivrad is true
...
//Change 2017/05/15: don't include whole group when Q = G
      if s ne Q or #Q ne #G then
        Append(~MM,mm);
      end if;
    end for;
  else
