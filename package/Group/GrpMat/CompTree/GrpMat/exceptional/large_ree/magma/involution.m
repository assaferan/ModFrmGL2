 ...
 *    Date      : $Date:: 2017-08-27 10:06:06 +1000 (Sun, 27 Aug 2017)       $:
 *    Last edit : $Author:: jbaa004                                          $:
 *
 *    $Id:: involution.m 3267 2017-08-27 00:06:06Z jbaa004                 $:
 *
 *****************************************************************************/
...
function check2ACentraliser(G, meatAxeData, largeSLPGroup, slpList)
	...
	if i eq middleSzIdx then
		...
		smallSLPCoercion;
	    diagonalBlocks[#diagonalBlocks]`slpGroup := W;
