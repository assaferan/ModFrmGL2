 ...
 *    Date      : $Date:: 2017-09-17 09:12:15 +1000 (Sun, 17 Sep 2017)       $:
 *    Last edit : $Author:: eobr007                                          $:
 *
 *    $Id:: extraspecial.m 3289 2017-09-16 23:12:15Z eobr007               $:
 *
 *****************************************************************************/
...
intrinsic HasC6Decomposition(G :: GrpMat : Randomiser :=
    ...
    ErrorProb := 2^(-1), MaxIterations := 15) -> BoolElt
    {
