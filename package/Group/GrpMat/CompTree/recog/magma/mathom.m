 ...
 *    Date      : $Date:: 2017-09-04 22:38:52 +1000 (Mon, 04 Sep 2017)       $:
 *    Last edit : $Author:: eobr007                                          $:
 *
 *    $Id:: mathom.m 3279 2017-09-04 12:38:52Z eobr007                     $:
 *
 *****************************************************************************/
...
// replacement of this function by new one made by Allan Steel 

// Does g preserve the given vector space subspace series?
function OldPreservesSubspaces(series, g)
// SLOW!!!
/*
"PreservesSubspaces:";
"Univ:", Universe(series);
"series:", (series);
"Par g:", Generic(Parent(g));
*/
    return forall{W : W in series | forall{b : b in Basis(W) | b^g in W}};
end function;

function PreservesSubspaces(series, g)
    return forall{W: W in series | RowspaceIsSub(BasisMatrix(W)*g, W)};
//assert res eq OldPreservesSubspaces(series, g);
//"PreservesSubspaces:", res;
    //return res;
end function;
