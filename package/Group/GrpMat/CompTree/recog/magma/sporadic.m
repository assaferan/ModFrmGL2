 ...
 *    Date      : $Date:: 2017-08-20 02:45:43 +1000 (Sun, 20 Aug 2017)       $:
 *    Last edit : $Author:: eobr007                                          $:
 *
 *    $Id:: sporadic.m 3263 2017-08-19 16:45:43Z eobr007                   $:
 *
 *****************************************************************************/
...
function RybaMembership(G, name, verify)
	...
	CentraliserMethod := 
            name cmpeq "U82" and Degree (G) eq 8 select "BSGS" else 
            RybaMembershipData[name]`CentraliserMembership,
...
function SporadicGoldCopyOrder(name)    
	...
	when "3U62"  : return #ATLASGroup("U62") * 3;
        ...
        when "O12p2"   : return 50027557148216524800;
