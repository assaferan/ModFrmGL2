...
/*=========================================================
  ...
  $Id: ClassicOrd.m 56494 2018-02-13 03:38:19Z don $
...
intrinsic OrderSU(n :: RngIntElt, q :: RngIntElt) -> RngIntElt
{The order of the special unitary group}
  if n eq 0 then return 1; end if;
  return q^Binomial(n,2) * &*[(q^i - (-1)^i): i in [2..n]];
end intrinsic;

intrinsic OrderCGU(n :: RngIntElt, q :: RngIntElt) -> RngIntElt
{The order of the conformal unitary group}
  return OrderGU(n,q)*(q-1);
end intrinsic;
