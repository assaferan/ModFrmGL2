...
S,DoubleDual,"Computes the graded double dual M** = Hom(Hom(M,can_R/I), can_R/I) where I is the annihilator of equidimensional module M over polynomial ring R. If retMap is true then the natural map M->M** is also computed and returned",0,3,0,0,0,0,0,0,0,36,,0,0,64,,0,0,270,,270,175,-38,-38,-38,-38
