...
{Returns true iff the KG-module M is projective}
...
intrinsic IsSelfDual(M::ModGrp) -> BoolElt
{Returns true iff the dual of the KG-module M is identical to M}

    return IsIsomorphic(Dual(M), M);
