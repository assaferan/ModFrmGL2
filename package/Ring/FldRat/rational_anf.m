...
intrinsic IsIsomorphic(R1::FldRat, R2::FldRat) -> BoolElt
{Return that the rational field is isomorphic to itself}
    return true;
end intrinsic;

intrinsic IsIsomorphic(R1::FldRat, R2::FldAlg) -> BoolElt
{Return that the rational field is isomorphic to a degree one extension of itself}
    return Degree(R2) eq 1;
end intrinsic;

intrinsic IsIsomorphic(R1::FldAlg, R2::FldRat) -> BoolElt
{Return that the rational field is isomorphic to a degree one extension of itself}
    return Degree(R1) eq 1;
end intrinsic;

intrinsic 'meet'(R1::FldRat, R2::FldRat) -> FldRat
{Return the rational field}
    return R1;
end intrinsic;

intrinsic Eltseq(r::FldRatElt, Q::FldRat) -> SeqEnum
{Return [r]};
    return [r];
end intrinsic;
