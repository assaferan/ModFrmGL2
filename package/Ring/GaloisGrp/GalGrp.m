...
intrinsic IntersectionOfWreathProducts(BlockSysSet :: SetEnum) -> GrpPerm
{BlockSysSet is set of sets of sets of integers, 
 encoding block systems of a permutation group.
 This function returns the largest permutation group having all these block systems.}

 return IntersectionOfWreathProducts([[SetToSequence(b) : b in a] : a in BlockSysSet]);
end intrinsic;
