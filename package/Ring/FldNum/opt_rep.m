...
intrinsic OptimizedRepresentation(Q::FldRat :
   TrialDivisionLimit := 10^6,  PollardRhoLimit := 8191,
   ECMLimit := -1, MPQSLimit := -1, PartialFactorisation := false,  
   Discriminant:= false, Ramification := false) -> FldAlg, Map
{Utility function} return Q,hom<Q->Q|[]>;; end intrinsic;
