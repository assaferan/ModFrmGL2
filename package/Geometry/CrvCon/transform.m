...
intrinsic Conic(C::Crv) -> CrvCon, MapIsoSch
    ...
    require IsIrreducible(C): "Curve is not irreducible"; // MW Nov 2017
    require HasFunctionField(C): "Curve does not have a function field";
    ...
    C1 := phi(C);
    bool,C2 := IsConic(C1);
    require bool: "Image of divisor map is not a conic?";
