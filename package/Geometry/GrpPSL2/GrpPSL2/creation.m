...
intrinsic Subgroup(G::GrpPSL2, gens::SeqEnum, N::RngIntElt) -> GrpPSL2
...
intrinsic PSL2Subgroup(gens::SeqEnum, R::Rng, N::RngIntElt) -> GrpPSL2
     {returns the subgroup of PSL2(R) generated by gens}
     return Subgroup(PSL2(R), gens, N);
end intrinsic;
...
intrinsic PSL2Subgroup(H::GrpMat) -> GrpPSL2
 {returns a subgroup of PSL2(Z) whose image is H (assumes -I in H)}
     ...
     return Subgroup(PSL2(Integers()), gens, N);
end intrinsic;
