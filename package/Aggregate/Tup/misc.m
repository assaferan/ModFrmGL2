...
intrinsic Components(S::SetCart) -> List
{The components of a Cartesian product, given as a list}
 return [* Component(S,i) : i in [1..NumberOfComponents(S)] *]; end intrinsic;
