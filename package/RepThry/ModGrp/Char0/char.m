...
{Character of module m over Z/Q}
...
//"IrrChars:", IrrChars;
    ...
    if #IrrChars eq 0 and assigned G`RationalCharacterTable then
	IrrChars := RationalCharacterTable(G);
	vprint ZMeataxe: "RationalCharacterTable already computed";
    end if;
