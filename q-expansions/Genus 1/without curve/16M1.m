    ...
    /****************************************************
    Loading this file in magma loads the objects fs_16M1 
    and X_16M1. fs_16M1 is a list of power series which form 
    a basis for the space of cusp forms. X_16M1 is a 
    ...
    *****************************************************/
              ...
              fs_16M1 := [Kq | 1/2*(-zeta^2 + 2)*q^4 + (-zeta^2 + 2)*q^20 + 
...
10)*q^356 + O(q^368)] ;
              ...
              X_16M1 := Curve(P_Q, [ PolynomialRing(ext<K|Polynomial(K, [2, 0, 
